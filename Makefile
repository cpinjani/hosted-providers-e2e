...
e2e-import-tests: deps
	ginkgo -v -r --timeout=3h --keep-going --randomize-all --focus "P0Importing" ./hosted

e2e-provisioning-tests: deps
	ginkgo -v -r --timeout=3h --keep-going --randomize-all --focus "P0Provisioning" ./hosted

e2e-support-matrix-tests: deps
	ginkgo -v -r --timeout=3h --keep-going --randomize-all --focus "SupportMatrix" ./hosted
